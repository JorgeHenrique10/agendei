...
{
    public class DeletarProcedimentoCommand : Notifiable, ICommand
    {
        public DeletarProcedimentoCommand()
        {

        }

        public DeletarProcedimentoCommand(Guid id, string nome, string descricao, double valor)
        {
            Id = id;
            Nome = nome;
            Descricao = descricao;
