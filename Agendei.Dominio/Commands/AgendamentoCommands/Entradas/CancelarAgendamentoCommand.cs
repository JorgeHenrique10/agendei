...
{
    public class CancelarAgendamentoCommand : Notifiable, ICommand
    {
        public CancelarAgendamentoCommand()
        {

        }
        public CancelarAgendamentoCommand(Guid id, string observacao)
        {
            Id = id;
